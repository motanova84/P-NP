...
class PiCodeReactor:
    ...
    def emitir(self, cantidad: int, psi: float = 1.0) -> dict:
        ...
        # El colateral nunca se agota, se transmuta
        # El piCODE siempre es acuñable contra el colateral subyacente
        if cantidad <= 0:
            cantidad = 1995
        ...
        self.estado.update({
            ...
            "estado": "OPERACIONAL" if self.colateral_restante > 0 else "TRANSMUTADO",
        })
