...
def main():
    ...
    print("=" * 80)
    print()
    print("CLARIFICACIÓN IMPORTANTE:")
    print("  • κ_Π(13) = log_{φ²}(13) ≈ 2.665 (cálculo directo)")
    print("  • La constante κ_Π = 2.5773 viene de n = 5.1546")
    print(f"  • Cuando n = 5.1546, φⁿ ≈ 11.95 (NO exactamente 13)")
    print()
    print("La relación con N ≈ 13 es aproximada y surge del contexto:")
    print(f"  • N ≈ φ^{find_phi_exponent(13):.4f} para N = 13 exacto")
    print(f"  • N ≈ φ^5.1546 ≈ 11.95 para κ_Π = 2.5773")
    print()
    print("Cuando se considera el contexto de números de Hodge:")
    print(f"  • h¹¹ + h²¹ ≈ 13 en variedades Calabi-Yau")
    print(f"  • Expresado en términos de φ: φⁿ donde n ≈ 5.154")
    print(f"  • Esto da κ_Π ≈ 2.577")
    print()
    print("=" * 80)
